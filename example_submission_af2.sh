...
OUTPUT_DIR="/zhome/projects/project.maxove.anryg/de_novo_binder_scoring/outputs"
INPUT_PDBS="./example_input/input_pdbs"
INPUT_CSV="./example_input/input.csv"
SCRIPT_DIR="/zhome/projects/project.maxove.anryg/de_novo_binder_scoring/outputs"
