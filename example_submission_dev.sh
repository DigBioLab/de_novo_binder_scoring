...
OUTPUT_DIR="/zhome/projects/project.maxove.anryg/minibinder_scoring_dev/example_output_1"
INPUT_PDBS="./example_input/input_pdbs"
INPUT_CSV="./example_input/input.csv"
SCRIPT_DIR="/zhome/projects/project.maxove.anryg/minibinder_scoring_dev"
